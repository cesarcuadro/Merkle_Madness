        ...
        while (true) {
            ...
            if (sNewWord != null) {
                ...
                if (lstWords.size() == iMerkleTreeInputs) {
                    // TODO: set MerkleManager.sMerkleRoot to the merkle
                    //  root generated by the getMerkleRoot method on util class.
                    MerkleManager.merkleRoot = objUtil.getMerkleRoot();
                }
            }
        }
    }
